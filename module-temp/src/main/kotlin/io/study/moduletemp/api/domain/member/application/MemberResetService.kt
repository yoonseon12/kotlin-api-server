...
import io.study.moduletemp.api.domain.member.domain.event.ResetPasswordEvent
...
class MemberResetService(
    ...
    fun resetPassword(request: io.study.moduletemp.api.domain.member.domain.dto.request.MemberResetPasswordRequest) {
        ...
        memberDomainService.resetPassword(
            io.study.moduletemp.api.domain.member.domain.dto.request.MemberResetPasswordRequest(
                request.email,
                tempPassword
            )
        )
